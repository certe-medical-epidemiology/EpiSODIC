...
test_that("episodic_count_phrase() can omit the leading number", {
  expect_equal(episodic_count_phrase(1, "geval", "gevallen", with_number = FALSE), "geval")
  expect_equal(episodic_count_phrase(5, "geval", "gevallen", with_number = FALSE), "gevallen")
})
