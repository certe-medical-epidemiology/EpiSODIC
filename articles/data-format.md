...
a postcode is country-specific: a rule reading the first digit and
returning one of three Dutch provinces would put Dutch province names on
the streams, dashboard and outbreak reports of any instance elsewhere
whose postcodes start 7, 8 or 9, silently.
