...
its `EPISODE_CONFIG` overrides, its provisioned accounts - lives
entirely outside the package, addressed by environment variables
(`EPISODE_DB`, `EPISODE_CONFIG`, `EPISODE_GEO_DATA`, …; see the README’s
“Environment variables” table for the full list). Nothing about a
specific laboratory, hospital, or patient can enter this repository,
...
[`episode_run_app()`](https://certe-medical-epidemiology.github.io/EpiSODIC/reference/episode_run_app.md)
