...
- The new-clusters email’s Cases, Expected, Ratio, Priority, and Period
  columns are now horizontally centred, and the Period column is
  formatted the same way the dashboard formats date ranges
