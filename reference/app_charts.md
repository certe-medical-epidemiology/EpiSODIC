...
Static, not interactive - keeping the app's dependency footprint to a
single, ubiquitous CRAN plotting package rather than an htmlwidgets
stack is a deliberate simplification.
