...
display via
[`shiny::HTML()`](https://rdrr.io/pkg/shiny/man/reexports.html) (e.g.
*Escherichia coli*); names `AMR` does not recognise as a species (e.g.
"Influenza A", a virus type rather than a binomial) pass through
...
package as a whole, used here and by `episodic_dedup()`. Text is
...
and an operator's own custom template (`EPISODIC_QUARTO_REPORT`) should
