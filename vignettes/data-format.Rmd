...
the shipped `r doc_system_file("inst/config/episodic_default_pathogen_config.csv")` - and it does this correctly across
...
(`r doc_system_file("inst/extdata/geo_postcodes4_nl.rds")`), geometry only, sourced from
