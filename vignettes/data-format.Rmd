...
resistance pattern - is not itself part of the case data contract, and is
...
own contract: `episodic_check_denominators()` for positivity metadata,
...
values (its own contract, not `episodic_case_data`'s - there is no file
