...
access removed, that is also a job for whoever administers the database
(there is no self-service reset either) - reach out to them rather than
trying to work around it yourself.

</details>

<details>
<summary><strong>What is the difference between an "assessor" and an "admin" account, and how do I decide who needs which?</strong></summary>
