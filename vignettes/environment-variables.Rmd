...
temporary SQLite file and every shipped default. See `vignettes/deployment.Rmd`
for `EPISODIC_DB` and `EPISODIC_CONFIG`/`EPISODIC_PALETTE_CONFIG` in
context, and the README's "Database backend", "Geographic reference
data" and "Custom report templates" sections for the detail behind each
of the rows above.
