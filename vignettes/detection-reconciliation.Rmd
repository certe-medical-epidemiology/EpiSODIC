...
admin confirmed as a real epidemic is excluded from what
...
small number of *persistent* clusters an admin can actually track:
...
3. A cluster nobody's seen a new candidate for this run gets its
   ...
   variation. Anything an admin has actually classified as worth
