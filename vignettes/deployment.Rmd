...
see the system working, run `EpiSODE::episode_demo()` instead - no data,
no credentials, no configuration required.

## The two things you provide

EpiSODE never connects to a laboratory information system, data
warehouse, or any other data source itself - that step is deliberately
yours, run before EpiSODE, so the package stays reusable by any
...
is nothing EpiSODE-specific about the scheduling itself.
...
|---|---|---|
| House-style colours | `certestyle` | Shipped default palette |
