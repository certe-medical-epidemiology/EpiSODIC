...
to this repository. `r doc_system_file("inst/config/episodic_default_config.yaml")` ships the documented
...
schema (`r doc_system_file("inst/sql/schema.sql")`) is written once, in SQLite syntax, and
...
`episodic_report_render()` renders the shipped `r doc_system_file("inst/report/episodic_default_report.qmd")`
...
(`r doc_system_file("inst/config/episodic_default_style.yaml")`), overridable per instance by pointing
