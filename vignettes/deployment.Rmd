...
`episodic_add_user()` at the console.
...
for a bilingual report. `diff` is `NULL` for a cluster's first-ever
render and otherwise holds what changed since the previous version -
