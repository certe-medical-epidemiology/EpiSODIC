...
to this repository. `inst/config/episodic_default_config.yaml` ships the documented
...
through a *separate* environment variable (`EPISODIC_PALETTE_CONFIG`):
...
`episodic_report_render()` renders `inst/report/episodic_default_report.qmd`
...
(`inst/config/episodic_default_style.yaml`), overridable per instance by pointing
