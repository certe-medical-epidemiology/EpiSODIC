...
### The Clusters screen: one outbreak at a time
...
recorded as occurring during it. A seasonal epidemic carries a
declaration form where an epidemiologist records whether the season has
started, has not yet started, or has ended, an act with policy
consequences across multiple hospitals that the system raises but never
